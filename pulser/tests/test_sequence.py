...
def test_abstract_repr():
    ...
    assert abstract["operations"][0] == {
        "op": "retarget", "channel": "digital", "target": "control"}
    assert abstract["operations"][2] == {
        "op": "pulse",
        "channel": "digital",
        "amplitude": {"kind": "BlackmanWaveform",
                      "duration": 200,
                      "area": 1.5707963267948966},
        "detuning": {"kind": "ConstantWaveform", "duration": 200, "value": 0.0},
        "phase": 4.71238898038469,
        "post_phase_shift": 0.0
    }

    assert abstract["operations"][5] == {
        "op": "align", "channels": ["digital", "rydberg"]}
